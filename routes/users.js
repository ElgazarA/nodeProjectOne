...
router.route("/cart").get(verifyToken, getUserCart).post(verifyToken, userCart);
...
router.route("/cart/:cartId").delete(verifyToken, removeFromCart);
router.route("/updateCart/:cartId/:newQTY").put(verifyToken, updateQTYCart);
